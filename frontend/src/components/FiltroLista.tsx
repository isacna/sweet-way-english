    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap">
      ...
      <div className="relative flex-1 min-w-48">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-200 bg-white text-sm text-[#1A1A1A] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8A4FF7]/20 focus:border-[#8A4FF7]"
        />
      </div>
      ...
      {filtros.map((f) => (
        <select
          ...
          aria-label={f.label}
          className="py-2.5 pl-3 pr-8 rounded-lg border border-gray-200 bg-white text-sm text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#8A4FF7]/20 focus:border-[#8A4FF7] appearance-none"
          style={{
      ...
      {temFiltroAtivo && (
        <div className="flex items-center gap-3 text-sm text-[#4A4A4A]">
          ...
          <button
            type="button"
            onClick={limparTudo}
            className="text-[#8A4FF7] hover:text-[#7742e0] font-medium whitespace-nowrap"
          >
            Limpar filtros
          </button>
        </div>
